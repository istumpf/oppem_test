import { VateProvider } from "./vate.provider";
  ...
  describe("createReport", () => {
    it("should create a report successfully", async () => {
      ...
      expect(mockedAxios.post).toHaveBeenCalledWith(
        ...
        {
          obra_id: mockReport.report_id,
          data: mockReport.date,
          clima: mockReport.weather,
          descricao: mockReport.description,
          equipe: mockReport.workers,
        },
        {
          timeout: 5000,
          headers: undefined,
  ...
  describe("updateReport", () => {
    it("should update a report successfully", async () => {
      ...
      expect(mockedAxios.put).toHaveBeenCalledWith(
        `${config.VATE_URL}/reports/mock-id-123`,
        {
          obra_id: mockReport.report_id,
          data: mockReport.date,
          clima: mockReport.weather,
